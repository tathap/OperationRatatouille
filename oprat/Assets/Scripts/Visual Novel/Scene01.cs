...
public class Scene01 : MonoBehaviour
{
    ...
    IEnumerator StartEvent()
    {
        ...
        if (eventPos == 6)
        {
            ...
            Baboon.gameObject.GetComponent<Rigidbody2D>().linearVelocity = Vector2.left * 30;
            yield return new WaitForSeconds(0.25f);
            Kyla.gameObject.GetComponent<Rigidbody2D>().linearVelocity = Vector2.zero;
            Baboon.gameObject.GetComponent<Rigidbody2D>().linearVelocity = Vector2.zero;
        }
        else if (eventPos == 11)
        {
            Kyla.gameObject.GetComponent<Rigidbody2D>().linearVelocity = Vector2.left * 30;
            Baboon.gameObject.GetComponent<Rigidbody2D>().linearVelocity = Vector2.right * 30;
            yield return new WaitForSeconds(0.25f);
            Kyla.gameObject.GetComponent<Rigidbody2D>().linearVelocity = Vector2.zero;
            Baboon.gameObject.GetComponent<Rigidbody2D>().linearVelocity = Vector2.zero;
        }
